// app/page.tsx — Javari Magazine Museum
// AI-powered vintage magazine collection
  ...
  return (
    <div style={{ background: '#07080f', minHeight: '100vh', color: 'white',
      ...
      <nav style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 100,
        ...
        <span style={{ fontWeight: 800, fontSize: 15, color: '#6366f1' }}>Javari Magazine Museum</span>
